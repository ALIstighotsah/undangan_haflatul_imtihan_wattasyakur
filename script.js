...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const defaultGuestName = "Wali Santri";
...
Saya *${currentGuest}*, ingin mengonfirmasi kehadiran saya pada acara Haflatul Imtihan Wattasyakkur di Pondok Pesantren Al-Istighotsah Assalafi Setu Bekasi.
